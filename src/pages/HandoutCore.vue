<template>
  ...
  -->
  <!-- To be deleted below -->
  <pinch-zoom backgroundColor="rgba(255,255,255,1.0)" v-for="(thisMaterials, index) in handoutCore" :key="thisMaterials.id" :name="index" style="text-align:center;" id="allowfullscreen">
...
export default {
  ...
  created: function() {
    axios
      ...
      .then(response => {
		  (this.handoutCore = response.data.handout),
