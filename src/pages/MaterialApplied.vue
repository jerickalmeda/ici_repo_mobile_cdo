<template>
  ...
  -->
  <!-- To be deleted below -->
  <div v-for="(thisMaterials, index) in materialApplied" :key="thisMaterials.id" :name="index" style="text-align:center;" id="allowfullscreen">
...
export default {
  ...
  created: function() {
    axios
      ...
      .then(response => {
		  (this.materialApplied = response.data.material),
