...
export default {
  data () {
    return {
	  ...
	  videoCore: [],  
      materialComplete: "statics/subjecttype/" +  this.$route.params.subjectType + "/"+ this.$route.params.courseCode +"/" + this.$route.params.subjectCode + "/" + this.$route.params.week.split(" ").join("") + "/video.mp4"
    }
  },
  created: function() {
    axios
